...
export const metadata: Metadata = {
  ...
  description: "Dr. Pratima Agale (BHMS, MD Homeopathy) — best homeopathy doctor serving Mumbai, Andheri & suburbs. Expert in women's health, PCOS, thyroid, pediatric care. Female homeopathy specialist. Online consultations available.",
  keywords: [
    "homeopathy doctor mumbai",
    "best homeopathy doctor in mumbai",
    "lady homeopathy doctor mumbai",
    "female homeopathy doctor mumbai",
    "homeopathy doctor andheri",
    "homeopathy doctor bandra",
    "homeopathy clinic mumbai",
    "women homeopathy doctor mumbai",
    "PCOS homeopathy mumbai",
    "thyroid homeopathy mumbai",
    "child homeopathy doctor mumbai",
...
// ─── JSON-LD: LocalBusiness for Mumbai ───────────────────────────────────────
...
export default function HomeopathyDoctorMumbaiPage() {
  return (
    <div className="pt-24">
      <BreadcrumbSchema
        items={[
      ...
      <script
        ...
        dangerouslySetInnerHTML={{ __html: JSON.stringify(mumbaiBusinessSchema) }}
      />
      ...
      >
        <div className="max-w-3xl mx-auto">
          ...
          >
            Homeopathy Doctor in Mumbai
            <span className="block italic text-sage-500">Dr. Pratima Agale MD</span>
          </h1>
          <p className="text-lg leading-relaxed mb-6" style={{ color: "var(--text-secondary)" }}>
            Best lady homeopathy doctor serving Mumbai, Andheri & suburbs. BHMS, MD Homeopathy specialist for women's health,
            PCOS, thyroid, pediatric care, and chronic diseases. Online consultations available.
          </p>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="text-center">
              ...
              <p className="text-sm" style={{ color: "var(--text-secondary)" }}>
                ...
                <span className="text-xs">(Accessible from Mumbai)</span>
              </p>
            </div>
            <div className="text-center">
              <div className="w-12 h-12 rounded-full bg-sage-100 flex items-center justify-center mx-auto mb-4">
      ...
      <section className="py-20 px-6" style={{ backgroundColor: "var(--bg-base)" }}>
        <div className="max-w-5xl mx-auto">
          ...
          >
            Homeopathy Services for Mumbai Patients
          </h2>
        ...
        <div className="max-w-5xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 gap-6">
            <div className="p-6 rounded-xl border" style={{ borderColor: "var(--border-color)" }}>
              ...
              <p className="text-sm" style={{ color: "var(--text-secondary)" }}>
                Convenient video consultations for Mumbai patients — no need to travel for every follow-up.
              </p>
            </div>
            <div className="p-6 rounded-xl border" style={{ borderColor: "var(--border-color)" }}>
      ...
      <section className="py-16 px-6 bg-sage-500 text-center">
        <div className="max-w-xl mx-auto">
          ...
          <p className="text-sage-100 mb-6">
            Convenient homeopathy consultations for Mumbai patients via WhatsApp or video call.
          </p>
          <a
            href="https://wa.me/919359875511?text=Hello%2C%20I%20am%20from%20Mumbai%20and%20would%20like%20to%20book%20a%20consultation%20with%20Dr.%20Pratima%20Agale."
            target="_blank"
            rel="noopener noreferrer"
