...
export const metadata: Metadata = {
  ...
  description: "Dr. Pratima Agale (BHMS, MD Homeopathy) — best homeopathy doctor serving Dombivli East & West. Expert in women's health, PCOS, thyroid, pediatric care. Female homeopathy specialist. Online & in-person consultations available.",
  keywords: [
    "homeopathy doctor dombivli",
    "best homeopathy doctor in dombivli",
    "lady homeopathy doctor dombivli",
    "female homeopathy doctor dombivli",
    "homeopathy doctor dombivli east",
    "homeopathy doctor dombivli west",
    "homeopathy clinic dombivli",
    "women homeopathy doctor dombivli",
    "PCOS homeopathy dombivli",
    "thyroid homeopathy dombivli",
    "child homeopathy doctor dombivli",
    "pediatric homeopathy dombivli",
...
// ─── JSON-LD: LocalBusiness for Dombivli ───────────────────────────────────────
const dombivliBusinessSchema = {
  ...
  areaServed: [
    ...
    { "@type": "City", name: "Dombivli East" },
    { "@type": "City", name: "Dombivli West" },
...
const areas = [
  "Dombivli East",
  "Dombivli West",
  "Dombivli (East) Station",
  "Dombivli (West) Station",
  "Phool Nagar",
  "Thakurli",
  "Manpada",
  "Kalyan (Nearby)",
...
export default function HomeopathyDoctorDombivliPage() {
  return (
    <div className="pt-24">
      <BreadcrumbSchema
        items={[
      ...
      <script
        ...
        dangerouslySetInnerHTML={{ __html: JSON.stringify(dombivliBusinessSchema) }}
      />
      ...
      >
        <div className="max-w-3xl mx-auto">
          ...
          >
            Homeopathy Doctor in Dombivli
            <span className="block italic text-sage-500">Dr. Pratima Agale MD</span>
          </h1>
          <p className="text-lg leading-relaxed mb-6" style={{ color: "var(--text-secondary)" }}>
            Best lady homeopathy doctor serving Dombivli East & West. BHMS, MD Homeopathy specialist for women's health,
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="text-center">
              ...
              <p className="text-sm" style={{ color: "var(--text-secondary)" }}>
                ...
                <span className="text-xs">(15 mins from Dombivli)</span>
              </p>
            </div>
            <div className="text-center">
              <div className="w-12 h-12 rounded-full bg-sage-100 flex items-center justify-center mx-auto mb-4">
      ...
      <section className="py-20 px-6" style={{ backgroundColor: "var(--bg-base)" }}>
        <div className="max-w-5xl mx-auto">
          ...
          >
            Homeopathy Services for Dombivli Patients
          </h2>
        ...
        <div className="max-w-5xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 gap-6">
            <div className="p-6 rounded-xl border" style={{ borderColor: "var(--border-color)" }}>
              ...
              <p className="text-sm" style={{ color: "var(--text-secondary)" }}>
                Convenient video consultations for Dombivli patients — no need to travel for every follow-up.
              </p>
            </div>
            <div className="p-6 rounded-xl border" style={{ borderColor: "var(--border-color)" }}>
      ...
      <section className="py-16 px-6 bg-sage-500 text-center">
        <div className="max-w-xl mx-auto">
          ...
          <p className="text-sage-100 mb-6">
            Convenient homeopathy consultations for Dombivli patients via WhatsApp or video call.
          </p>
          <a
            href="https://wa.me/919359875511?text=Hello%2C%20I%20am%20from%20Dombivli%20and%20would%20like%20to%20book%20a%20consultation%20with%20Dr.%20Pratima%20Agale."
            target="_blank"
            rel="noopener noreferrer"
