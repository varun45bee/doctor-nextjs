...
export default function ContactPage() {
  ...
  // Load general availability configuration on mount
  useEffect(() => {
                ...
                <>
                  ...
                  <form onSubmit={handleSubmit} className="space-y-5">
                    ...
                    <div className="space-y-2">
                      ...
                      {!form.date ? (
                        <div className="text-xs p-3.5 border border-dashed rounded-xl text-center text-zinc-400 dark:text-zinc-650 border-zinc-200 dark:border-zinc-800">
                          Please select a date first to view slot availability.
                        </div>
                      ) : loadingSlots ? (
                        <div className="text-xs p-3.5 text-center animate-pulse" style={{ color: "var(--text-secondary)" }}>
                          Checking slot availability...
                        </div>
                      ) : slotError ? (
                        <div className="text-xs p-3.5 bg-red-50 dark:bg-red-950/20 text-red-600 dark:text-red-400 border border-red-100 dark:border-red-900/30 rounded-xl text-center font-semibold">
                          {slotError}
                        </div>
                              ...
                              <button
                                ...
                                className={`p-2.5 rounded-xl text-xs font-semibold border text-center transition-all ${
                                  isSelected
                                    ...
                                    : isBooked
                                    ? "bg-zinc-50 border-zinc-250 dark:bg-zinc-850/10 dark:border-zinc-800 text-zinc-400 dark:text-zinc-600 cursor-not-allowed line-through"
                        ...
                        <div className="text-xs p-3.5 border border-dashed rounded-xl text-center text-zinc-400 dark:text-zinc-600 border-zinc-200 dark:border-zinc-800">
